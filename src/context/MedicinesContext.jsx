...
const initialMedicines = [
    ...
    { id: 2, name: 'Amoxicillin 250mg', barcode: '8901234567891', category: 'Antibiotics', batchNo: 'BTH-2026-002', expiry: '2026-04-20', purchaseUnit: 'Strip', sellingUnit: 'Capsule', unitsPerPack: 10, costPerPack: 320, sellingPricePerUnit: 45, totalStockUnits: 40, quantity: 4, purchasePrice: 32, sellingPrice: 45, supplier: 'PharmaDist Ltd.' },
    ...
    { id: 5, name: 'Metformin 500mg', barcode: '8901234567894', category: 'Diabetes', batchNo: 'BTH-2026-005', expiry: '2026-03-15', purchaseUnit: 'Strip', sellingUnit: 'Tablet', unitsPerPack: 10, costPerPack: 100, sellingPricePerUnit: 15, totalStockUnits: 30, quantity: 3, purchasePrice: 10, sellingPrice: 15, supplier: 'MedSupply Co.' },
    { id: 6, name: 'Azithromycin 500mg', barcode: '8901234567895', category: 'Antibiotics', batchNo: 'BTH-2026-006', expiry: '2026-05-18', purchaseUnit: 'Strip', sellingUnit: 'Tablet', unitsPerPack: 6, costPerPack: 360, sellingPricePerUnit: 85, totalStockUnits: 450, quantity: 75, purchasePrice: 60, sellingPrice: 85, supplier: 'PharmaDist Ltd.' },
    { id: 7, name: 'Ibuprofen 400mg', barcode: '8901234567896', category: 'Pain Relief', batchNo: 'BTH-2026-007', expiry: '2026-05-05', purchaseUnit: 'Strip', sellingUnit: 'Tablet', unitsPerPack: 10, costPerPack: 60, sellingPricePerUnit: 10, totalStockUnits: 25, quantity: 2, purchasePrice: 6, sellingPrice: 10, supplier: 'HealthCare Plus' },
    ...
    { id: 12, name: 'Ciprofloxacin 500mg', barcode: '8901234567901', category: 'Antibiotics', batchNo: 'BTH-2026-012', expiry: '2026-04-30', purchaseUnit: 'Strip', sellingUnit: 'Tablet', unitsPerPack: 10, costPerPack: 400, sellingPricePerUnit: 62, totalStockUnits: 45, quantity: 4, purchasePrice: 40, sellingPrice: 62, supplier: 'MediWholesale' },
]
